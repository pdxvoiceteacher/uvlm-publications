...
- `python -c "from pathlib import Path; from coherence.product.mvr_local_real_input_pilot import build_mvr_local_real_input_pilot_prototype; bridge=Path(r'C:\UVLM\run_artifacts\mvr_local_real_input_pilot\bridge'); build_mvr_local_real_input_pilot_prototype(bridge)"`
