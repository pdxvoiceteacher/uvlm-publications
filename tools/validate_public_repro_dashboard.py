    ...
    for phrase in FORBIDDEN_PHRASES:
        ...
        while True:
            ...
            if phrase in {"market validation", "federation", "omega detection", "federation authorization", "product readiness", "human benefit proof"} and (
                ...
                or ("observation contract policy simulation" in text[max(0, index - 900) : index + 500] and ("without" in text[max(0, index - 900) : index + 500] or "not" in text[max(0, index - 220) : index + 220] or "blocked overclaim" in text[max(0, index - 220) : index]))
            ...
            if phrase == "consent execution" and (
                ...
                or "mode shift simulation is consent execution" in text[max(0, index - 80) : index + 80]
                or "not consent execution" in text[max(0, index - 80) : index + 80]
            ):
                start = index + len(normalized_phrase)
                continue
