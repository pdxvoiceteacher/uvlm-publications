...
def _forbidden_hits(normalized_text: str, forbidden: tuple[str, ...]) -> list[str]:
    ...
    for phrase in forbidden:
        ...
        while True:
            ...
            ces_pmr_allowed_start = normalized_text.find(normalized_ces_pmr_allowed)
            ...
            while ces_pmr_allowed_start != -1:
                if ces_pmr_allowed_start <= index <= ces_pmr_allowed_start + len(normalized_ces_pmr_allowed):
                    ...
                    break
                ces_pmr_allowed_start = normalized_text.find(normalized_ces_pmr_allowed, ces_pmr_allowed_start + 1)
