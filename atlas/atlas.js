...
async function main() {
  ...
  const cy = cytoscape({
    ...
    style: [
      ...
      {
        selector: '.swarm-discovery',
        style: {
          'background-color': 'rgba(255, 223, 77, 0.92)',
          'border-color': '#ffe88f',
          'border-width': 3.2,
          'overlay-color': 'rgba(255, 223, 77, 0.32)',
          'overlay-opacity': 0.2,
          'overlay-padding': 3
        }
      },
      ...
      {
        selector: '.theory-terrace',
        style: {
          'background-color': 'rgba(171, 110, 255, 0.9)',
          'border-color': '#dcc0ff',
          'border-width': 3.0,
          'overlay-color': 'rgba(171, 110, 255, 0.28)',
          'overlay-opacity': 0.2,
          'overlay-padding': 3
        }
      },
      ...
      {
        selector: '.theory-evolution',
        style: {
          'background-color': 'rgba(114, 230, 182, 0.9)',
          'border-color': '#b9ffe2',
          'border-width': 3.0,
          'overlay-color': 'rgba(114, 230, 182, 0.28)',
          'overlay-opacity': 0.2,
          'overlay-padding': 3
        }
      },
      ...
      {
        selector: '.backtest-river',
        style: {
          'background-color': 'rgba(91, 224, 255, 0.9)',
          'border-color': '#c9f6ff',
          'border-width': 2.8
        }
      },
      {
        selector: '.backtest-terrace',
        style: {
          'background-color': 'rgba(177, 116, 255, 0.9)',
          'border-color': '#e4c7ff',
          'border-width': 2.8
        }
      },
      ...
      {
        selector: '.backtest-detected-corridor',
        style: {
          'background-color': 'rgba(252, 185, 76, 0.92)',
          'border-color': '#ffe0ad',
          'border-width': 3
        }
      },
      {
        selector: '.backtest-true-breakthrough',
        style: {
          'background-color': 'rgba(99, 223, 157, 0.92)',
          'border-color': '#c8ffe4',
          'border-width': 3
        }
      },
      {
        selector: '.backtest-false-positive',
        style: {
          'background-color': 'rgba(240, 88, 88, 0.92)',
          'border-color': '#ffc5c5',
          'border-width': 3
        }
      },
