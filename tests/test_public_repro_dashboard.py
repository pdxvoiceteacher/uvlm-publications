...
def test_publication_tooling_py_compile_regression():
    for tool in (
        BUILDER,
        VALIDATOR,
        Path("tools/validate_publication_claims.py"),
    ):
...
REQUIRED_DOCS = {
    ...
    "static-html-usability-review-seed.md",
    "static-html-usability-revision.md",
