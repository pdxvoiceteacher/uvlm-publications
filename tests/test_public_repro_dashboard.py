...
from tools.build_public_repro_dashboard import (
    ...
    OBSERVATION_CONTRACT_POLICY_SIMULATION_SCENARIO_IDS,
...
def test_observation_contract_policy_simulation_page_and_registry_are_generated(tmp_path):
    ...
    for artifact in OBSERVATION_CONTRACT_POLICY_SIMULATION_ARTIFACTS:
        ...
        assert artifact in page_text
        assert artifact in boundary_text
    for artifact in OBSERVATION_CONTRACT_POLICY_SIMULATION_INPUT_REFERENCES:
        assert artifact in page_text
        assert artifact in boundary_text
    for phrase_group in (
        OBSERVATION_CONTRACT_POLICY_SIMULATION_SCENARIO_IDS,
    ...
    assert "build_observation_contract_policy_simulation" in boundary_text
    ...
    assert status["observation_contract_policy_simulation_default_receipt_required"] is True
    assert status["observation_contract_policy_simulation_default_human_review_required"] is True
    assert status["observation_contract_policy_simulation_simulated_notice_delivered"] is False
    assert status["observation_contract_policy_simulation_simulated_consent_obtained"] is False
